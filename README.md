...
-In this project, will build a basic website that allows users to add/remove books from a list.The goal is to make it more organized by using modules
...
-  git clone https://github.com/siddghosh108/Awesomw-Books-ES6.git
...
- [ ] **[Project: Home (Pair-programming)]**
- [ ] **[Project: awesome books (pair-programming)]**
